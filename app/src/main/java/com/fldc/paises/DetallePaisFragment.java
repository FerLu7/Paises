...
import com.fldc.paises.databinding.FragmentDetallePaisBinding;
import com.fldc.paises.placeholder.PlaceholderContent;
...
public class DetallePaisFragment extends Fragment {
  ...
  private PlaceholderContent.Pais mPais;
    ...
    private int getImageId(String imagePath){
        ...
        return getResources().getIdentifier((imageName), "drawble", getContext().getPackageName());
    }
}